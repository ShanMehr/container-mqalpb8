...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-mqalpb8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-mqalpb8.containers.anotherwebservice.com/
...
```
git clone git@github.com:ShanMehr/container-mqalpb8.git
cd container-mqalpb8
```
...
```
docker attach container-mqalpb8
```
